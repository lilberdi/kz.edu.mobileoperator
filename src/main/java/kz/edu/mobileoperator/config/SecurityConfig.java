...
import kz.edu.mobileoperator.service.impl.UserAccountDetailsService;
...
public class SecurityConfig {
    ...
    /**
     * UserDetailsService, который будет использован Spring Security.
     */
    @Bean
    public UserDetailsService userDetailsService(UserAccountDetailsService delegate) {
        return delegate;
    }
}
